...
public class Hashtable<K, V> extends Dictionary<K, V> implements Map<K, V>, Cloneable, java.io.Serializable
{
    ...
    /**
     * Returns an enumeration of the keys in this hashtable. 返回此hashtable中键的枚举。
     * 
    ...
    public synchronized boolean containsKey(Object key)
    {
        ...
        // hash & 0x7FFFFFFF: 和最大整数01111111.....（32位）按位与，负数会变为正数其他不变
        // (hash & 0x7FFFFFFF) % tab.length： 和length取余就更简单了 你不能让8
        // 成为长度为7的table的index 取余后为1，这就没问题了
    ...
    /**
     * 要分配的数组的最大大小。一些vm在数组中保留一些标题词。试图分配更大的数组可能会导致OutOfMemoryError
     */
     ...
     * table is known. The modCount is not incremented and there's no
